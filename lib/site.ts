...
export const SITE_DESCRIPTION =
  "Sage Summit Capital is the holding and operating platform behind Vantage Rock Financial — building AI-native finance and operating infrastructure for founder-led and sponsor-backed middle-market companies.";
...
/** The one active operating company. */
